                ...
                <div class="relative p-12 w-full sm:max-w-2xl sm:mx-auto">
                    <div class="overflow-hidden z-0 rounded-full relative p-3">
                        <form onSubmit={handeleSearch} role="form" class="relative flex z-50 bg-white rounded-full">
                            ...
                            <button type='submit' class="bg-black text-white rounded-full font-semibold px-8 py-4 hover:bg-indigo-600 duration-700 transition  focus:bg-indigo-600 focus:outline-none">Search</button>
                        </form>
            ...
            <div class="bg-white p-4 flex items-center justify-center flex-wrap">
                <nav aria-label="Page navigation">
                    <ul class="inline-flex">
                        <li><button onClick={handleBack} class="px-4 py-2 text-green-600 transition-colors duration-150 bg-white border border-r-0 border-green-600 rounded-l-lg focus:shadow-outline hover:bg-green-100">Prev</button></li>
                        {
                            pages.map(page=> 
                        ...
                        <li><button onClick={handleNext} class="px-4 py-2 text-green-600 transition-colors duration-150 bg-white border border-green-600 rounded-r-lg focus:shadow-outline hover:bg-green-100">Next</button></li>
                    </ul>
                </nav>
            </div>
        </div>
